...
class ChatViewController2: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    @IBOutlet weak var roomBack: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        tableView.frame = CGRect(x: 0, y: statusBarHeight + (navigationController?.navigationBar.frame.size.height)!, width: view.frame.size.width, height: view.frame.size.height - statusBarHeight - (navigationController?.navigationBar.frame.size.height)! - 120)
        
        roomBack.frame = CGRect(x: 0, y: statusBarHeight + (navigationController?.navigationBar.frame.size.height)!, width: view.frame.size.width, height: view.frame.size.height - statusBarHeight - (navigationController?.navigationBar.frame.size.height)! - 120)
        
        messageTextField.frame = CGRect(x: view.frame.size.width * 0.05, y: view.frame.size.height - 80, width: view.frame.size.width * 0.75, height: 30)
        sendButton.frame = CGRect(x: view.frame.size.width * 0.80, y: 0, width: 60, height: 60)
